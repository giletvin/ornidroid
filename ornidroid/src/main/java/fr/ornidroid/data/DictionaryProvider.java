...
public class DictionaryProvider extends ContentProvider {
	...
	/** The AUTHORITY. */
	public static String AUTHORITY = "fr.ornidroid.data.DictionaryProvider";
	...
	private Cursor getSuggestions(String query) {
		...
		final Cursor cursor = getDao().getBirdMatches(query);
	 ...
	 * @return the word
	 */
	private Cursor getWord(final Uri uri) {
	...
	private Cursor search(String query) {
		query = query.toLowerCase();
		final Cursor cursor = this.getDao().getBirdMatches(query);
