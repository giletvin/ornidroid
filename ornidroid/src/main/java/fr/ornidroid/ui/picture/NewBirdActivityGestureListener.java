...
import fr.ornidroid.ui.components.ImagesFragment;
 ...
 * @see GestureEvent
 */
public class NewBirdActivityGestureListener extends SimpleOnGestureListener {
	...
	/** The bird activity. */
	private final NewBirdActivity birdActivity;
	/** The slide left in. */
	...
	/** The images frament. */
	private final ImagesFragment imagesFrament;
	 ...
	 *            the bird activity
	 */
	public NewBirdActivityGestureListener(final ImagesFragment pImagesFragment) {
		this.imagesFrament = pImagesFragment;
		this.birdActivity = (NewBirdActivity) pImagesFragment.getActivity();
	...
	public boolean onDoubleTap(final MotionEvent e) {
		if (TabsPagerAdapter.PICTURE_TAB == this.birdActivity.getCurrentTabId()) {

			final int displayedPictureId = this.imagesFrament
					.getDisplayedPictureId();
			this.imagesFrament.resetViewFlipper();
