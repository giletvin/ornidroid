...
-- release 11.3.0 version 30
insert into release_notes(id,version_code,date,comments_en,comments_de,comments_fr,read) VALUES(6,30,"22/06/2017","","","",0);

update release_notes set comments_fr=" * Version 11.3.0 (22/06/2017)
Evolutions : corrections dans la base de données, nombreuses nouvelles photos en ligne : pensez à activer l''option de vérification de mises à jour pour avoir des notifications !

 * Version 11.2.0 (31/01/2016)
Evolutions : 
...
" where version_code=30;

update release_notes set comments_en=" * Version 11.3.0 (06/22/2017)
Evolutions : few fixes in the db, new pictures online : you can set the check for updates option to get them.

 * Version 11.2.0 (01/31/2016)
New features:
